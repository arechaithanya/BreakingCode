  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4 font-sans">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-20 w-96 h-96 bg-[#00ff88]/5 rounded-full blur-[100px]" />
      ...
      >
        ...
        <div className="glass p-8 rounded-3xl border border-white/10 shadow-2xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-gray-400 uppercase tracking-wider mb-1.5 ml-1">Display Name</label>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-white/5 border ${errors.displayName ? 'border-red-500/50' : 'border-white/10'} rounded-xl py-2.5 pl-10 pr-4 text-white focus:outline-none focus:border-[#00ff88]/50 transition-colors placeholder:text-gray-600`}
                  placeholder="e.g. codemaster99"
                />
              </div>
              {errors.displayName && <p className="mt-1 text-xs text-red-400 ml-1">{errors.displayName.message}</p>}
            </div>
              ...
              <div className="mt-3 grid grid-cols-2 gap-2">
                {passwordRequirements.map((req, i) => (
                  <div key={i} className="flex items-center gap-1.5">
                    ...
                    <span className={`text-[10px] ${req.met ? 'text-[#00ff88]' : 'text-gray-500'}`}>{req.label}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type={showPassword ? 'text' : 'password'}
                  className={`w-full bg-white/5 border ${errors.confirmPassword ? 'border-red-500/50' : 'border-white/10'} rounded-xl py-2.5 pl-10 pr-4 text-white focus:outline-none focus:border-[#00ff88]/50 transition-colors placeholder:text-gray-600`}
                  placeholder="••••••••"
                />
              </div>
            ...
            <button
              ...
              className="w-full bg-[#00ff88] hover:bg-[#00dd77] text-black font-bold py-3 rounded-xl shadow-[0_0_20px_rgba(0,255,136,0.2)] hover:shadow-[0_0_30px_rgba(0,255,136,0.4)] transition-all flex items-center justify-center gap-2 mt-6 disabled:opacity-50 disabled:cursor-not-allowed group"
            >
              {isSubmitting ? (
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="text-[#00ff88] hover:underline font-medium">Log in</Link>
          </p>
        </div>
      </motion.div>
    </div>
